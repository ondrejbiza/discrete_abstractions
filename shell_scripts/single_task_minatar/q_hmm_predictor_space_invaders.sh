...
dir_path="results/icml/q_hmm_predictor_space_invaders"
...
for (( i=1; i<=$num_runs; i++ )); do
    ...
    python -m scripts.bisim.minatar.learn_predict_q_hmm_prior dataset/space_invaders.pickle space_invaders \
    ...
    --q-scaling-factor 1.0 --eval-episodes 100 --softmax-policy --softmax-policy-temp 0.0005
