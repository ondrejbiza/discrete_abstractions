...
def main(args):
    ...
    env = ContinuousPuckStack(
        ...
        depth_size=args.depth_size, random_shape=args.random_shape, action_failure_prob=args.action_failure_prob
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--random-shape", default=False, action="store_true")
    parser.add_argument("--action-failure-prob", type=float, default=0.0)
