...
import os
import matplotlib
from runners.bisim.lehnert_gridworld.LehnertGridworldApproxPartition import LehnertGridworldApproxPartitionRunner
from utils.logger import Logger
from utils.saver import Saver
import constants
import config_constants as cc

SAVE_PREFIX = "{:s}/lehnert_gridworld_approx_v1"
SAVE_TEMPLATE = "{:s}_round_to_{:d}_{:.2f}_eps{:s}"
...
def main(args):
    ...
    runner_config = {
        ...
        cc.LOGGER: logger, cc.EPSILON: args.epsilon
    }
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Run approximate partition iteration over a model.")

    parser.add_argument("load_model_path", help="model load path")
    parser.add_argument("--data-limit", type=int, default=None, help="data limit (only for naming save files)")
    ...
    parser.add_argument("--epsilon", type=float, default=0.1, help="slack constant")
