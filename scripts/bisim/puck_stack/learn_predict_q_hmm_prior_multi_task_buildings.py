...
from runners.bisim.puck_stack.QHMMPriorMultiTaskBuildings import QHMMPriorMultiTaskBuildings

SAVE_PREFIX = "{:s}/q_hmm_predictor_multi_task_buildings_v1"
...
def main(args):
    ...
    runner = QHMMPriorMultiTaskBuildings(
        ...
        only_one_q_value=args.only_one_q_value, disable_resize=args.disable_resize, oversample=args.oversample,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Learn to predict q-values for multiple tasks with an HMM prior in Building World.")
