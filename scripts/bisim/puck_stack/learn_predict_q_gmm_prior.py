...
SAVE_PREFIX = "{:s}/q_gmm_predictor_v2"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Learn to predict q-values with a GMM prior in Shapes World.")
    ...
    parser.add_argument("--gifs-path", help="save gifs path")
