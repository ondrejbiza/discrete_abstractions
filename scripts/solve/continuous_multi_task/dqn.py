...
def main(args):
    ...
    env = ContinuousMultiTask(
        args.num_blocks, args.num_pucks, fcs, args.num_actions, height_noise_std=args.height_noise_std,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Train a DQN on multiple tasks in the shapes world.")
